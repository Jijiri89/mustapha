    ...
    <div class="container mx-auto mt-8 px-4">
        <div class="card border border-yellow-900 lg:mx-1 m-1 p-8">
            <div class="w-full card card border-yellow-900 bg-white shadow-md p-8">
                ...
                <p class="whitespace-normal leading-normal"><strong>WhatsApp:</strong> 0245631300</p>
                <p class="whitespace-normal leading-normal"><strong>Telephone:</strong> 0207787847 / 0245631300</p>
                <p class="whitespace-normal leading-normal"><strong>Email:</strong> seidumustaphastoph@gmail.com</p>

                <p class="mt-4 whitespace-normal leading-normal"><strong>Service Overview:</strong>
                    JAZAKH-ALLAH VENTURES provides innovative solutions and services to meet your needs.</p>

                <p class="mt-4 whitespace-normal leading-normal"><strong>Mobile Menu:</strong>
                ...
                <p class="mt-4 whitespace-normal leading-normal"><strong>Contacting Us:</strong>
                    For inquiries or assistance, feel free to reach out to us through WhatsApp, telephone, or email.</p>

                <!-- Add more sections as needed -->

                <p class="mt-4 whitespace-normal leading-normal"><strong>Acceptance of Terms:</strong>
